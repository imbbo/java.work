...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		// chaAt(index): 문자열 인덱스에 따른 단일 문자 반환.
		char c = str.charAt(4);
		...
		int idx1 = str.indexOf("l"); // L임 소문자 L l 찾기 
		System.out.println("idx1:" + idx1);
		
		int idx2= str.lastIndexOf("l"); // 뒤에서부터 검색하고 싶으면 lastIndexOf
		...
		double d = Double.parseDouble(s2); // 문자열 -> 정수
