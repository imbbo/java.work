...
public abstract class HeadStore {
	...
	/*
	 # 추상 클래스, 추상 메서드(클래스 앞에도 붙여)
	 
	 1. 추상 클래스의 메서드의 abstract를 붙이면 해당 메서드는 
	 ...
	 일반 멤버변수 및 일반 메서드도 얼마든지 선언이 가능합니다.
	 (오버라이딩 강제 하고 싶은 부분만 abstract 붙이면 됨)
	 */
	...
	public void orderWaterMelon() {
		System.out.println("수박 쥬스의 가격은 4000원 입니다."); // 얘도 잘됨
	}
