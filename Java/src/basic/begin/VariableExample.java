...
//		int score = 95; x
		score =95;
		// 하나에 변수에 다른 값을 대입하면 기존 값은 사라지고 새로 대입한 값이 대입된다.
		//변수는 변수 하나당 하나밖에 대입할 수 없다.
...
//		int count = "한번"; x
//		int count = 23.5; x 실수라서
//		String str = 100; x 타입이 맞지 않는다.
		
		//변수는 자료형(데이터 타입)이 달라도 이름이 동일하다면
		//중복 선언할 수 없습니다.
		String name = "홍길동";
//		int name = 1004; x name 중복 선언
		
		//선언 및 초기화하지 않은 변수는 사용이 불가능합니다.
//		int result = myScore + num; x num이 선언 안됨
		int result;
//		System.out.println(result); x result 초기화 안됨
	}
