...
//		int my birth day = 19921013; x 
		...
		int myBirthDay = 19921013; // camel case 붙여쓰는 단어는 첫시작단어에 대문자 표기(국룰)
...
//		String class = "클래스"; x
		String Class = "클래스"; //(가능은 하나 권하지는 않는다.)
		String className = "클래스"; // 사용하겠다면 이런식으로
		...
		System.out.println(number7111);
		
		//클래스이름은 대문자 시작, 변수의 이름은 소문자로 시작, 변수의 이름은 대충 하지않기
	}
