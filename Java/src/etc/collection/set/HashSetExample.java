...
public class HashSetExample {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 예측할 수 없는 값을 이욯하기 때문에 정렬이 불가능.
		 - 생성된 값으로 원래 값을 찾는 것도 불가능에 가까움
		 - 다시 원래 값으로 돌아갈 수 없는 단방향성 알고리즘
		 - 속도가 빠르고 보안성이 뒤어난 알고리즘, 객체의 주소값을 할당하거나
		 암호화 알고리즘에 많이 사용됩니다.
		 */
		...
		while(iter.hasNext()) { // 꺼낼거가 있을때는 true라 계속 돌지만 
			//꺼낼게 없을떄는 false로 바귀며 반복문이 종료됩니다.
		...
		} // 위와 동일하다 이게 더 간단, while(true)를 써도는 되지만 이게 더 편함
