...
public class ListQuiz02 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		User kim = new User("김양환", 27);
		User hong = new User("홍길동", 28);
		User moon = new User("문일환", 26);
//		user.add(new User("홍길동", 20)); 이렇게 해도 됨
//		user에 작성을 해놔서 값이 뜨지만 주석 위 처럼 하면 주소값이 출력됨
		Collections.addAll(user, kim, hong, moon);
		
//		for(int i=0; i<user.size(); i++) {
//			System.out.println(user);
//		}
//			if(user.contains(hong)) {
//				user.remove(hong);
//				
//			}
//		}					쓰다가 시간 끝
...
//					,a.getName(), a.getAge());
		...
		/*
		 ...
		 - 향상 for문은 반복문을 시작할 떄 구조적으로 컬렉션의
